...
- [The `pxp` skill](pxp/AGENTS.md) guides screenshot-driven UI implementation and measured refinement.
- `pxp-review-loop` guides human-annotated review rounds and explicit approval handoff.
- Skill evaluation packaging belongs to [the evaluation helpers](pxp/evals/AGENTS.md).
