...
- [Image comparison](../imagediff/AGENTS.md): provides `ImageComparison` and image artifact paths.
- [Artifact persistence](../artifact/AGENTS.md): provides safe filesystem writing.
- [Command orchestration](../commands/AGENTS.md): assembles report input after command processing.
